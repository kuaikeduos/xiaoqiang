...
<div class={`xq-message xq-message-${type}`}>
  <div class='xq-message__icon'>
    {#if type === 'error'}
      <Icon name={type} style='color: #f5222d;' />
    {/if}
    {#if type === 'success'} 
  ...
  <div class='xq-message__content'>{content}</div>
</div>
